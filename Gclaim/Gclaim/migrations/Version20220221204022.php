 ...
 */
final class Version20220221204022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tournoi CHANGE idjeu idjeu_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tournoi DROP FOREIGN KEY FK_18AFD9DFE8239482');
        $this->addSql('DROP INDEX IDX_18AFD9DFE8239482 ON tournoi');
        $this->addSql('ALTER TABLE tournoi CHANGE nomtournoi nomtournoi VARCHAR(50) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description VARCHAR(200) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE idjeu_id idjeu INT DEFAULT NULL');
