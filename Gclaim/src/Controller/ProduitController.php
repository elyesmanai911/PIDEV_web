...
//        ]);
     ...
     */
    public function filtreprodprix(ProduitRepository $produitRepository, CategorieRepository $categorieRepository, Request $request): Response
    {
    ...
    /**
     * @Route("/prod/prods/pdfd/{id_produit}", name="pdfd", methods={"GET"})
     */
