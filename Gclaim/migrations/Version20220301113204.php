 ...
 */
final class Version20220301113204 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD membre_equipe_id INT DEFAULT NULL');
